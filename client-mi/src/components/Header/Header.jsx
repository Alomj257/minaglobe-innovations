...
const Shapes = () => (
	<>
		...
		<svg
			className="ezy__header42-shape-two"
			width="49"
			height="40"
			viewBox="0 0 49 40"
			fill="none"
		...
		<svg
			className="ezy__header42-shape-four"
			width="90"
			height="81"
			viewBox="0 0 90 81"
			fill="none"
		...
		<svg
			className="ezy__header42-shape-six"
			width="149"
			height="255"
			viewBox="0 0 149 255"
			fill="none"
		...
		<div className="ezy__header42-bg-shape" />
	</>
);

const ShapeSeven = () => (
	<svg
		className="ezy__header42-shape-seven position-absolute top-0"
		width="291"
		height="168"
		viewBox="0 0 291 168"
		fill="none"
...
const HeroHeader = () => {
	return (
		<header className="ezy__header42 light">
			<Shapes />
			...
			<Container>
				<Row className="align-items-center">
					...
					>
						<h2 className="ezy__header42-heading mb-4">
							Let's Reveal Something New!
						</h2>
						<Row>
							<Col xs={12} lg={8}>
								<p className="ezy__header42-sub-heading mb-5">
						...
						<Button href="/contact-us" variant="" className="ezy__header42-btn rounded-pill">
							Contact Us
						</Button>
					</Col>
					<Col xs={12} lg={5} className="position-relative text-center">
						...
						<div>
							<img
								...
								alt=""
								className="img-fluid ezy__header42-img"
							/>
						</div>
					</Col>
				</Row>
